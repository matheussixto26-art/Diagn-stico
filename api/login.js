...
module.exports = async (req, res) => {
    try {
        ...
        // A busca de turmas (rooms) é crucial, então a fazemos primeiro e de forma separada.
        ...
        const dashboardData = {
            userInfo,
            roomUserData, // Garantindo que os dados das turmas sejam enviados ao frontend
        ...
        // **** LINHA CORRIGIDA ****
        // Enviamos todos os dados do painel E TAMBÉM o tokenB para o frontend usar.
        res.status(200).json({ ...dashboardData, tokenB: tokenB });
